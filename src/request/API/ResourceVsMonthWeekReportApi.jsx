...
const ResourceVsMonthWeekReportApi = () => {
  ...
  useEffect(() => {
    if (
      ...
      async function getlistdetails() {
        const response = await request.post(
          API_TEST_URL,
          "report/getresourcevsmonthdetails",
          postRequest
        );
...
export default ResourceVsMonthWeekReportApi;
