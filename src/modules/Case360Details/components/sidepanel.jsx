    ...
    <React.Fragment>
      <div className="information">
        <Accordion defaultActiveKey="0">
          ...
          <Accordion.Collapse eventKey="0">
            <div className="info-table" style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
...
export const ActivitiesPanel = () => {
  const [selectedItem, setSelectedItem] = useState("Case 001");
  const items = ["Case 001", "Case 002", "Case 003", "Case 004", "Case 005"];
  const handleSelect = (item) => {
    setSelectedItem(item);
  };
  return (
