...
import { postDataInfo } from "@/redux/Journey/selector";
...
import EditTask from "@/components/JourneyComp/Wijmo/components/Update/EditTask";
import {
  SelectedRowContext,
                ...
                <div className="list-header-inside">
                  ...
                  <div className="action-add">
                    ...
                    <div className="view-btn-group">
                      <ArcToolTip
                        HoverText="List view"
                        BtnName={<MdOutlineFormatListBulleted />}
                        Placement="top"
                        className={`view-btn ${
                          PageView === "list" ? "active" : ""
                        }`}
                        onClick={() => {
                          setPageView("list");
                        }}
                      ...
                      />
                      <ArcToolTip
                        HoverText="Journey view"
                        BtnName={<MdViewQuilt />}
                        Placement="top"
                        className={`view-btn ${
                          PageView === "grid" ? "active" : ""
                        }`}
                        onClick={() => {
                          setPageView("grid");
                        }}
