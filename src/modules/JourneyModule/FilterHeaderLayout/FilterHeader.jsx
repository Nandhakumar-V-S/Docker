...
import { HorizontalGrouping } from "@/components/JourneyComp/Filters/HorizontalGrouping";
import { CustomizeTable } from "@/components/JourneyComp/Filters/CustomizeTable";
import { GroupByFilter } from "@/components/JourneyComp/Filters/GroupbyFilter";
import { CustomFilters } from "@/components/JourneyComp/Filters/CustomFilters";
import { ImTree } from "react-icons/im";
import { IoFilterSharp } from "react-icons/io5";
import { MdOutlineTableChart } from "react-icons/md";
import { VscSettings } from "react-icons/vsc";
import { ContextWidthProvider } from "@/context/widthContext/widthContext";
import QuickFilterHeader from "@/components/JourneyComp/Filters/QuickFilterHeader";
...
export default function FilterHeader({ Tableloading, setTableLoading }) {
  ...
  return (
    <>
      <div
        className={`filter-section ${JourneyIsGrouping ? "is-grouping" : null}`}
      >
