...
import { HorizontalGrouping } from "@/components/TaskComp/Filters/HorizontalGrouping";
import { CustomizeTable } from "@/components/TaskComp/Filters/CustomizeTable";
import { GroupByFilter } from "@/components/TaskComp/Filters/GroupbyFilter";
import { CustomFilters } from "@/components/TaskComp/Filters/CustomFilters";
import { ImTree } from "react-icons/im";
import { IoFilterSharp } from "react-icons/io5";
import { MdOutlineTableChart } from "react-icons/md";
import { VscSettings } from "react-icons/vsc";
import { ContextWidthProvider } from "@/context/widthContext/widthContext";
import QuickFilterHeader from "@/components/TaskComp/Filters/QuickFilterHeader";
...
import { horizontalGroupByMasterInfo } from "@/redux/Task/selector";
import { loadingInfo } from "@/redux/Task/selector";
import {
...
import { ListContext } from "@/modules/TaskModule/index";
import {
  horizontalGroupByDirInfo,
  selectedFiltersInfo,
  matchedLookupInfo,
  textFilterInfo,
...
export default function FilterHeader({ Tableloading, setTableLoading }) {
  ...
  const { taskIsGrouping } = useContext(ArcGlobalContextProvider);

  console.log(taskIsGrouping);
  // ~ New GroupBy
  ...
  return (
    <>
      <div
        className={`filter-section ${taskIsGrouping ? "is-grouping" : null} ${
