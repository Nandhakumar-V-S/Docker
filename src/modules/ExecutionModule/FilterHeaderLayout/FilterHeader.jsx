...
import { HorizontalGrouping } from "@/components/ExecutionComp/Filters/HorizontalGrouping";
import { CustomizeTable } from "@/components/ExecutionComp/Filters/CustomizeTable";
//import { GroupByFilter } from "@/components/ExecutionComp/Filters/GroupbyFilter";
...
import QuickFilterHeader from "@/components/ExecutionComp/Filters/QuickFilterHeader";
...
import { horizontalGroupByMasterInfo } from "@/redux/Execution/selector";
import { loadingInfo } from "@/redux/Execution/selector";
import { setHorizontalGroupBy } from "@/redux/Execution/actions";
// ~ New GroupBy
...
export default function FilterHeader({ Tableloading, setTableLoading }) {
  ...
  return (
    <>
      <div
        className={`filter-section ${entIsGrouping ? "is-grouping" : null} ${
      ...
      >
        ...
        {entIsGrouping ? (
          <HorizontalGroupByComponent
            ...
            masterid={HorizontalGroupbyMasterid}
            optionid={
              HorizontalGroupbyOptionid.length === 0
                ? "All"
