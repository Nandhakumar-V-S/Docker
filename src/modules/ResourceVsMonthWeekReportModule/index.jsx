...
import WijmoLayout from "@/modules/ResourceVsMonthWeekReportModule/WijmoLayout/WijmoLayout";
import ListHeader from "./components/ListHeader";

import FilterHeaderLayout from "@/modules/ResourceVsMonthWeekReportModule/FilterHeaderLayout/FilterHeaderLayout";
...
export default function ResourceVsMonthWeekReportModule() {
  ...
  // const [key, setKey] = useState("resourcevsmonthweek");

  // const handleNavigation = (k) => {
  //   console.log("navigate worked");
  //   sessionStorage.setItem("reportKey", k);
  //   console.log(k);
  //   const pathToNavigate = `/${k}`;
