...
const ContactDetails = () => {
  ...
  const selectEntityStatus = (state) => state.entity.status;
  const selectEntityError = (state) => state.entity.error;
  ...
  return (
    <>
      <UpdateStatus360
        show={UpdateStatus360show}
        setShow={setUpdateStatus360show}
        SelectedRow={entityResultsData}
        // SelectedRow={entityResultsData}
      />
...
const formatValue = (value, apiName) => {
  ...
  if (["utbl_Workitem_column30", "column30"].includes(apiName)) {
