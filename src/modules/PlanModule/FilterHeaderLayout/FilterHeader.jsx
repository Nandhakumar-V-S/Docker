...
import { HorizontalGrouping } from "@/components/PlanComp/Filters/HorizontalGrouping";
import { CustomizeTable } from "@/components/PlanComp/Filters/CustomizeTable";
// import { GroupByFilter } from "@/components/PlanComp/Filters/GroupbyFilter";
import { CustomFilters } from "@/components/PlanComp/Filters/CustomFilters";
import { ImTree } from "react-icons/im";
import { IoFilterSharp } from "react-icons/io5";
import { MdOutlineTableChart } from "react-icons/md";
import { VscSettings } from "react-icons/vsc";
import { ContextWidthProvider } from "@/context/widthContext/widthContext";
import QuickFilterHeader from "@/components/PlanComp/Filters/QuickFilterHeader";
...
import { horizontalGroupByMasterInfo } from "@/redux/Plan/selector";
import { loadingInfo } from "@/redux/Plan/selector";
import { setHorizontalGroupBy } from "@/redux/Plan/actions";
// ~ New GroupBy
// ~ Filter List
import {
  FilterListHeader,
...
export default function FilterHeader({ Tableloading, setTableLoading }) {
  ...
  return (
    <>
      <div
        className={`filter-section ${planIsGrouping ? "is-grouping" : null} ${
      ...
      >
        ...
        {planIsGrouping ? (
          <HorizontalGroupByComponent
            ...
            isAllDefault={
              horizontalGroupBy[0]?.api_name === "PlanTimeline" ? false : true
            }
          />
        ) : null}
