...
import { HorizontalGrouping } from "@/components/ActivitylogComp/Filters/HorizontalGrouping";
import { CustomizeTable } from "@/components/ActivitylogComp/Filters/CustomizeTable";
import { GroupByFilter } from "@/components/ActivitylogComp/Filters/GroupbyFilter";
import { CustomFilters } from "@/components/ActivitylogComp/Filters/CustomFilters";
import { ImTree } from "react-icons/im";
import { IoFilterSharp } from "react-icons/io5";
import { MdOutlineTableChart } from "react-icons/md";
import { VscSettings } from "react-icons/vsc";
import { ContextWidthProvider } from "@/context/widthContext/widthContext";
import QuickFilterHeader from "@/components/ActivitylogComp/Filters/QuickFilterHeader";
...
import { horizontalGroupByMasterInfo } from "@/redux/Activitylog/selector";
import { loadingInfo } from "@/redux/Activitylog/selector";
import { setHorizontalGroupBy } from "@/redux/Activitylog/actions";
import { horizontalGroupByDirInfo } from "@/redux/Activitylog/selector";
// ~ New GroupBy
// ~ Filter List
import {
  FilterListHeader,
...
export default function FilterHeader({ Tableloading, setTableLoading }) {
  ...
  console.log(activitylogIsGrouping);
  // ~ New GroupBy
  ...
  return (
    <>
      <div
        className={`filter-section ${activitylogIsGrouping ? "is-grouping" : null
