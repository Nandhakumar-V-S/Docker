...
import WijmoFlexgrid from "@/components/NotesComp/Wijmo/WijmoFlexgrid";
import WijmoPagination from "@/components/NotesComp/Wijmo/WijmoPagination";
...
import { setPagination, setPagesize } from "@/redux/Notes/actions";
...
const DataTable = ({ loading }) => {
  ...
  useEffect(() => {
    sessionStorage.setItem("360Pagename", "Notes");
  }, []);
  useEffect(() => {
