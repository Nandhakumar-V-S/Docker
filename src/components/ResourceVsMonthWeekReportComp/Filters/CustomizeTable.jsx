...
import { toggleColumnMapping } from "@/redux/ResourceVsMonthWeekReport/actions";
import { totalColumnsInfo } from "@/redux/ResourceVsMonthWeekReport/selector";
              ...
              {MappedColumns.filter((item) =>
                ...
                <label key={index}>
                  ...
                  <input
                    ...
                    disabled={relevantColumns.includes(item.api_name)}
                  />
                  {item.name}
                </label>
              ))}
