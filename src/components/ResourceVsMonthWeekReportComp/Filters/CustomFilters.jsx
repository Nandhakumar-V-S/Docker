...
export const CustomFilters = ({
  ...
  const [applyaddfilter, setapplyaddfilter] = useState({});
  ...
  const relevantFilters = ["workweek", "workday", "workmonth"];
  return (
    <>
      <ArcAlertPopup
                    ...
                    <Dropdown.Menu>
                      <>
                        ...
                        {filterAddData
                          .filter(
                            (item) =>
                              item.api_name !== "workweek" &&
                              item.api_name !== "workmonth"
                          )
                          .map((item) => {
                            console.log(item);
                            return (
