...
} from "@/redux/Report/selector";

import { createGroupByData } from "@/redux/Report/actions";
    ...
    <>
      ...
      >
        ...
        <div className="footer-div">
          ...
          <button onClick={handleGroupFilterPopup}  title="Cancel" className="cancel">
            Cancel
          </button>
          <button
            onClick={() => {
...
const GroupByDropDown = ({ type, onSelect }) => {
  ...
  console.log(createdGroupByData);
  ...
  useEffect(() => {
    ...
    console.log(setOption[0]);
    // if (setOption.length > 0) {
    //   console.log(newOptions);
    //   setOptions([setOption[0], ...newOptions]);
    //   setSelectedValue(setOption[0]);
    // }
  }, [groupByData, type, createdGroupByData]);
