...
const ArcTagInputV2 = ({
  ...
  const handleInputChange = (e) => {
    ...
    setQuery(newQuery);
    setPage(1);
    Fetchlookupdetails(newQuery, 1, Limit);
  ...
  const handleNewTag = (query) => {
    ...
    const newQuery = "";
    Fetchlookupdetails(newQuery, page, Limit);
  };
  ...
  const loadMoreData = () => {
    ...
    setPage(newPage);
    Fetchlookupdetails(query, newPage, Limit);
  };
      ...
      >
        ...
        {isFocused && (
          <>
            ...
            <div className="suggestions-dropdown-main with-tag">
