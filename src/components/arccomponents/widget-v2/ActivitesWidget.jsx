...
export default function ActivitesWidget({ ActivitiesData, Title, divWidth }) {
  ...
  return (
    <React.Fragment>
      <ArcWidget className={`arc-activites-widget div-${divWidth}`}>
        <WidgetHeader
          Title={Title}
  ...
  return (
    <React.Fragment>
      <ArcWidget className="arc-activites-widget arc-activites-widget-v2">
        <WidgetHeader Title={"Ticket Escalations"} />
