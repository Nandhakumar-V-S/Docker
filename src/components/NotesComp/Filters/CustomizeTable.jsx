...
import { toggleColumnMapping } from "@/redux/Notes/actions";

import { useDispatch, useSelector } from "react-redux";

import ArcToolTip from "@/components/arccomponents/ui-components/ArcTooltip/ArcTooltip";
import { totalColumnsInfo } from "@/redux/Notes/selector";
          ...
          <div className="content quick-filter">
            ...
            <div className="checkbox-div mapped visible-data">
              {MappedColumns.filter((item) =>
                ...
                <label key={index}className={`${item.istitle ? "label-disabled" : ""}`}>
                  <GrDrag />{" "}
                  <input
                    type="checkbox"
                    // defaultChecked={true}
