...
import { toggleColumnMapping } from "@/redux/Activitylog/actions";

import { useDispatch, useSelector } from "react-redux";

import ArcToolTip from "@/components/arccomponents/ui-components/ArcTooltip/ArcTooltip";
import { totalColumnsInfo } from "@/redux/Activitylog/selector";
...
export const CustomizeTable = ({
  ...
  return (
    <>
      <div
        className={`custom-filtered-div filtered-table-div ${CustomTabelPopup && "active"
          }`}
      >
