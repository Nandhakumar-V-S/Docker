...
// ~ Updated QuickFilter Settings
import QuickFilterSetting from "@/components/arccomponents/utility/QuickFilterSetting";
// ~ Updated QuickFilter Settings
              ...
              <Accordion>
                <Accordion.Collapse eventKey="0">
                  <QuickFilterSetting
                    ...
                    setMappedCheckboxes={setMappedCheckboxes}
                    unmappedCheckboxes={unmappedCheckboxes}
                    setUnmappedCheckboxes={setUnmappedCheckboxes}
                    searchTerm={searchTerm}
                    setSearchTerm={setSearchTerm}
                    filterData={filterData}
                    relevantFilters={relevantFilters}
                    handleArcOffCanvaClose={handleArcOffCanvaClose}
