...
import { toggleColumnMapping } from "@/redux/TaskInfo/actions";

import { useDispatch, useSelector } from "react-redux";

import ArcToolTip from "@/components/arccomponents/ui-components/ArcTooltip/ArcTooltip";
import { totalColumnsInfo } from "@/redux/TaskInfo/selector";
...
export const CustomizeTable = ({
   ...
   const MappedColumns = totalColumns?.filter((item) => item.ismapped && item.visible);
   const unMappedColumns = totalColumns?.filter((item) => !item.ismapped && item.visible);
   ...
   useEffect(() => {
      const handleOutsideClick = (event) => {
         const buttonClicked =
            CustomeTablebuttonRef.current && CustomeTablebuttonRef.current.contains(event.target);
   ...
   return (
      <>
         <div className={`custom-filtered-div filtered-table-div ${CustomTabelPopup && "active"}`}>
            ...
            <div className='main-div'>
               <div className='content quick-filter'>
                  <p>
                     ...
                     <span>
                        {" "}
                        {mappedColumnsLength}/{mappedColumnsLength + unMappedColumnslength}
                     </span>
                  </p>
