...
import { toggleColumnMapping } from "@/redux/ImportHistory/actions";

import { useDispatch, useSelector } from "react-redux";

import ArcToolTip from "@/components/arccomponents/ui-components/ArcTooltip/ArcTooltip";
import { totalColumnsInfo } from "@/redux/ImportHistory/selector";
        ...
        <div className="main-div">
          <div className="content quick-filter">
            ...
            <div className="checkbox-div unmapped not-visible-data">
              ...
              {unMappedColumns.length === 0 && <label>No Fields Found.</label>}
            </div>
          </div>
        </div>
