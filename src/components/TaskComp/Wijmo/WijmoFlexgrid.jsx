...
import { masterDataInfo, listDataInfo } from "@/redux/Task/selector";
...
import { selectedFiltersInfo } from "@/redux/Task/selector";
// ~ Selected Filter
// ! Import
const WijmoFlexgrid = ({ loading, tableData, sortedColumns }) => {
  ...
  // ~ Selected Filter
  console.log(FilterDropdownShow);
      ...
      <>
        ...
        {!loadingData[rowId] && (
          ...
          >
            ...
            />
            <FlexGridColumn header="Effort" binding="column4" />
            <FlexGridColumn
              header="Closed On"
      ...
      {loading ? (
        ...
        <FlexGrid
          ...
          className={`list-data-table ${
            taskIsGrouping ? "is-grouping" : null
          } ${
