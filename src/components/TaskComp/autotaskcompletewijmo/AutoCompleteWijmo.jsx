...
import { masterDataInfo } from "@/redux/Task/selector";
...
const AutoCompleteWijmo = ({
  ...
  const { setSelectedRow1, setEditTaskShow, setAddTaskShow } =
  ...
  const { ArcFilterPopupshow, setArcFilterPopupshow } =
    useContext(SelectedRowContext);
  // * Popup State
  ...
  // console.log(EditTaskshow, "edittaskicon");
    ...
    <>
      ...
      {loading ? (
        ...
        <FlexGrid
          ...
          allowSorting={true}
          autoGenerateColumns={false}
          className={`list-data-table ${taskIsGrouping ? "is-grouping" : null}`}
          headersVisibility="Column"
...
export default AutoCompleteWijmo;
