...
const TaskReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.TASK_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.TASK_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.TASK_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.TASK_SELECT_NEW_ENTITY: {
    ...
    case types.TASK_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.TASK_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.TASK_FETCH_LIST_DATA_SUCCESS:
    ...
    case types.TASK_SET_PAGINATION:
    ...
    case types.TASK_FETCH_DATASET_SUCCESS: {
    ...
    case types.TASK_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.TASK_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.TASK_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.TASK_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.TASK_CREATE_HOR_GROUPBYDATA_DIRECTION: {
    ...
    case types.TASK_CREATE_HOR_GROUPBYDATA: {
      const { payload } = action;
      console.log(payload);
    ...
    case types.TASK_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.TASK_SELECTED_FILTER_VALUE: {
    ...
    case types.TASK_ADD_ADDITIONAL_FILTER: {
    ...
    case types.TASK_SET_DROPDOWN_CHECKED: {
    ...
    case types.TASK_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASK_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.TASK_REMOVE_QUICK_FILTER: {
    ...
    case types.TASK_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.TASK_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.TASK_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.TASK_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.TASK_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.TASK_SORTED_COLUMN: {
    ...
    case types.TASK_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.TASK_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.TASK_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASK_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASK_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.TASK_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.TASK_SET_DATEPICKER_VALUE: {
    ...
    case types.TASK_SET_WEEKFILTER_VALUE: {
    ...
    case types.TASK_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.TASK_CHANGE_MASTER_DATA: {
    ...
    case types.TASK_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.TASK_EDIT_CELL: {
    ...
    case types.TASK_SET_CURRENTPAGE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.TASK_RESET_EDIT_CELL: {
      const resetEditcell = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: null,
        workitemid: "",
