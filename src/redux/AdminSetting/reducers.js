...
const initialState = {
  entities: [],
  entityid: "5CDC0F7A-0670-45A8-B87E-3B131390931C",
  listid: "8202CFF6-0A0D-47AF-9516-EACE2B886C96",
  userid: "",
  newEntity: "",
  masterData: [],
  list: [],
...
const AdminSettingReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.ADMINSETTING_GET_USERNAME: {
    ...
    case types.ADMINSETTING_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.ADMINSETTING_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.ADMINSETTING_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.ADMINSETTING_SELECT_NEW_ENTITY: {
    ...
    case types.ADMINSETTING_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.ADMINSETTING_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.ADMINSETTING_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.ADMINSETTING_SET_PAGINATION:
    ...
    case types.ADMINSETTING_SET_PAGE_SIZE:
      return {
        ...state,
        postData: {
          ...state.postData,
    ...
    case types.ADMINSETTING_FETCH_DATASET_SUCCESS: {
    ...
    case types.ADMINSETTING_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.ADMINSETTING_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.ADMINSETTING_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.ADMINSETTING_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.ADMINSETTING_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.ADMINSETTING_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.ADMINSETTING_SELECTED_FILTER_VALUE: {
    ...
    case types.ADMINSETTING_ADD_ADDITIONAL_FILTER: {
    ...
    case types.ADMINSETTING_SET_DROPDOWN_CHECKED: {
    ...
    case types.ADMINSETTING_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.ADMINSETTING_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.ADMINSETTING_REMOVE_QUICK_FILTER: {
      console.log(action.payload);
    ...
    case types.ADMINSETTING_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.ADMINSETTING_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.ADMINSETTING_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.ADMINSETTING_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.ADMINSETTING_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.ADMINSETTING_SORTED_COLUMN: {
    ...
    case types.ADMINSETTING_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.ADMINSETTING_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.ADMINSETTING_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.ADMINSETTING_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.ADMINSETTING_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.ADMINSETTING_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.ADMINSETTING_SET_DATEPICKER_VALUE: {
    ...
    case types.ADMINSETTING_SET_WEEKFILTER_VALUE: {
    ...
    case types.ADMINSETTING_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.ADMINSETTING_CHANGE_MASTER_DATA: {
    ...
    case types.ADMINSETTING_SET_LOADING: {
      return {
        ...state,
