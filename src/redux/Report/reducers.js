...
const initialState = {
  ...
  listid: "793EAE42-3DA2-4DC0-875F-46C76075FDAE",
  userid: 1000,
  newEntity: "",
  masterData: [],
  list: [],
...
const ReportReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.REPORT_SET_CURRENTPAGE: {
    ...
    case types.REPORT_GET_USERNAME: {
    ...
    case types.REPORT_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.REPORT_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.REPORT_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.REPORT_SELECT_NEW_ENTITY: {
    ...
    case types.REPORT_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.REPORT_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.REPORT_FETCH_DATASET_SUCCESS: {
      console.log(action.payload);
    ...
    case types.REPORT_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.REPORT_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.REPORT_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.REPORT_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.REPORT_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.REPORT_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.REPORT_SELECTED_FILTER_VALUE: {
    ...
    case types.REPORT_ADD_ADDITIONAL_FILTER: {
    ...
    case types.REPORT_SET_DROPDOWN_CHECKED: {
    ...
    case types.REPORT_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.REPORT_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.REPORT_REMOVE_QUICK_FILTER: {
    ...
    case types.REPORT_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.REPORT_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.REPORT_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.REPORT_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.REPORT_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.REPORT_SORTED_COLUMN: {
    ...
    case types.REPORT_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.REPORT_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.REPORT_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.REPORT_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.REPORT_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.REPORT_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.REPORT_SET_DATEPICKER_VALUE: {
    ...
    case types.REPORT_SET_WEEKFILTER_VALUE: {
    ...
    case types.REPORT_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.REPORT_CHANGE_MASTER_DATA: {
