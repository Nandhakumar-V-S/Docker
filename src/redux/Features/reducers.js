...
const FeaturesReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.FEATURES_GET_USERNAME: {
    ...
    case types.FEATURES_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.FEATURES_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.FEATURES_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.FEATURES_SELECT_NEW_ENTITY: {
    ...
    case types.FEATURES_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.FEATURES_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.FEATURES_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.FEATURES_SET_PAGINATION:
    ...
    case types.FEATURES_SET_PAGE_SIZE:
      return {
        ...state,
        postData: {
          ...state.postData,
    ...
    case types.FEATURES_FETCH_DATASET_SUCCESS: {
    ...
    case types.FEATURES_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.FEATURES_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.FEATURES_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.FEATURES_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.FEATURES_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.FEATURES_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.FEATURES_SELECTED_FILTER_VALUE: {
      ...
      // updatedTextFilters = textFilter.find(())
      return {
        ...state,
        postData: {
          ...updatedPostData,
    ...
    case types.FEATURES_REMOVE_TEXT_FILTER: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.FEATURES_ADD_ADDITIONAL_FILTER: {
    ...
    case types.FEATURES_SET_DROPDOWN_CHECKED: {
    ...
    case types.FEATURES_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FEATURES_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.FEATURES_REMOVE_QUICK_FILTER: {
    ...
    case types.FEATURES_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.FEATURES_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.FEATURES_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
      // Check if action.payload is an array or not
      if (Array.isArray(action.payload)) {
    ...
    case types.FEATURES_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.FEATURES_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.FEATURES_SORTED_COLUMN: {
    ...
    case types.FEATURES_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.FEATURES_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.FEATURES_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FEATURES_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FEATURES_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.FEATURES_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.FEATURES_SET_DATEPICKER_VALUE: {
    ...
    case types.FEATURES_SET_WEEKFILTER_VALUE: {
    ...
    case types.FEATURES_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.FEATURES_CHANGE_MASTER_DATA: {
    ...
    case types.FEATURES_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.FEATURES_EDIT_CELL: {
    ...
    case types.FEATURES_RESET_EDIT_CELL: {
      const resetEditcell = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: null,
        workitemid: "",
