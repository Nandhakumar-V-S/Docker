...
export const fetchUnpaidBills = createAsyncThunk(
  "unpaidBills/fetchUnpaidBills",
  async () => {
    const response = await fetch(`${OFFLINE_API_BASE_URL}Plan_Home_Followups`, {
      method: "GET",
      headers: {
...
const unpaidBillsSlice = createSlice({
  name: "unpaidBills",
  initialState: {
    data: [],
...
export default unpaidBillsSlice.reducer;
