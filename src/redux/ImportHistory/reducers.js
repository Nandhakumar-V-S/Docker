...
const initialState = {
  entities: [],
  entityid: "6785FF3A-C8F9-4848-ADB0-E22F6F7B305F",
  listid: "99947FB2-9E4C-4BEB-8BDE-EFDB1710F9FA",
  userid: "",
  newEntity: "",
  masterData: [],
  list: [],
...
const ImportHistoryReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.IMP_HIS_GET_USERNAME: {
    ...
    case types.IMP_HIS_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.IMP_HIS_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.IMP_HIS_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.IMP_HIS_SELECT_NEW_ENTITY: {
    ...
    case types.IMP_HIS_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.IMP_HIS_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.IMP_HIS_ADD_ADDITIONAL_FILTER: {
    ...
    case types.IMP_HIS_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.IMP_HIS_SET_PAGINATION:
    ...
    case types.IMP_HIS_SET_PAGE_SIZE:
      return {
        ...state,
        postData: {
          ...state.postData,
    ...
    case types.IMP_HIS_FETCH_DATASET_SUCCESS: {
      ...
      if (filters.length > 0) {
        filters
          ?.filter((filter) => filter.filterid === "createdon")
          .forEach((filter) => {
    ...
    case types.IMP_HIS_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.IMP_HIS_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.IMP_HIS_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.IMP_HIS_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.IMP_HIS_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.IMP_HIS_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.IMP_HIS_SELECTED_FILTER_VALUE: {
    ...
    case types.IMP_HIS_SET_DROPDOWN_CHECKED: {
    ...
    case types.IMP_HIS_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.IMP_HIS_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.IMP_HIS_REMOVE_QUICK_FILTER: {
    ...
    case types.IMP_HIS_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.IMP_HIS_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.IMP_HIS_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.IMP_HIS_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
        newDatasetID: "",
      };
    case types.IMP_HIS_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.IMP_HIS_SORTED_COLUMN: {
    ...
    case types.IMP_HIS_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.IMP_HIS_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.IMP_HIS_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.IMP_HIS_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.IMP_HIS_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.IMP_HIS_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.IMP_HIS_SET_DATEPICKER_VALUE: {
    ...
    case types.IMP_HIS_SET_WEEKFILTER_VALUE: {
    ...
    case types.IMP_HIS_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.IMP_HIS_CHANGE_MASTER_DATA: {
    ...
    case types.IMP_HIS_SET_LOADING: {
      return {
        ...state,
...
export default ImportHistoryReducer;
