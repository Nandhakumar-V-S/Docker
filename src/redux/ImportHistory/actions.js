...
export const setMultiselectChecked = (masterid, selectedValue, isChecked) => ({
  type: types.IMP_HIS_SET_MULTISELECT_CHECKED,
  payload: {
    masterid,
    selectedValue,
    isChecked,
...
export const removeAllFilters = (filterId) => ({
  type: types.IMP_HIS_REMOVE_ALL_FILTER,
  payload: filterId,
});
export const removeQuickFilter = (filterId) => ({
  type: types.IMP_HIS_REMOVE_QUICK_FILTER,
  payload: filterId,
});
export const removeAdvancedFilter = (filterId) => ({
  type: types.IMP_HIS_REMOVE_ADVANCED_FILTER,
  payload: filterId,
});
export const setTextValue = (textValues) => ({
  type: types.IMP_HIS_QUICK_TEXT_VALUE,
  payload: textValues,
});
export const resetCheckedValues = (filterid) => ({
  type: types.IMP_HIS_RESET_QUICK_FILTER_VALUES,
  payload: filterid,
});
export const createDataset = (dataSet) => ({
  type: types.IMP_HIS_CREATE_NEW_DATASET,
  payload: dataSet,
});
export const updateDataset = (dataSet) => ({
  type: types.IMP_HIS_EDIT_DATASET,
  payload: dataSet,
});
export const setNewDatasetID = (dataSetID) => ({
  type: types.IMP_HIS_GET_NEW_DATASET_INFO_SUCCESS,
  payload: dataSetID,
});
export const deleteDataset = (dataSetID) => ({
  type: types.IMP_HIS_DELETE_DATASET_DB,
  payload: dataSetID,
});
export const sortColumn = (dataindex) => ({
  type: types.IMP_HIS_SORTED_COLUMN,
  payload: { dataindex },
});

export const updateColumnSeq = (columnSequence) => ({
  type: types.IMP_HIS_SET_COLUMN_SEQ,
  payload: columnSequence,
});

export const updatedNewLayout = (newLayout) => ({
  type: types.IMP_HIS_SET_NEW_LAYOUT,
  payload: newLayout,
});
export const setAdvMultiOptionChecked = (
  ...
  type: types.IMP_HIS_SET_ADV_MULTISELECT_CHECKED,
  payload: {
    masterid,
    selectedValue,
    isChecked,
...
export const setAdvOptionChecked = (masterid, selectedValue, isChecked) => ({
  type: types.IMP_HIS_SET_ADV_DROPDOWN_CHECKED,
  payload: {
    masterid,
    selectedValue,
    isChecked,
...
export const setDatepicker = (id, api_name, name, date, formattedDate) => ({
  type: types.IMP_HIS_SET_DATEPICKER_VALUE,
  payload: {
    id,
    api_name,
    name,
...
export const setWeekfilter = (id, api_name, name, week, year) => ({
  type: types.IMP_HIS_SET_WEEKFILTER_VALUE,
  payload: {
    id,
    api_name,
    name,
...
export const resetDatefilters = () => ({
  type: types.IMP_HIS_RESET_DATE_FILTERS,
});
export const changeMasterdata = (masterid, api_name, week, selectedYear) => ({
  type: types.IMP_HIS_CHANGE_MASTER_DATA,
  payload: {
    masterid,
    api_name,
    week,
...
export const getImpUsername = (name, globalid) => ({
  type: types.IMP_HIS_GET_USERNAME,
  payload: { name, globalid },
});

export const setLoading = (status) => ({
  type: types.IMP_HIS_SET_LOADING,
  payload: status,
});

export const incrementRenderCount = () => ({
  type: types.IMP_HIS_INCREMENT_COUNT,
});
export const setdataSetID = (id) => ({
  type: types.IMP_HIS_SET_DATASETID,
  payload: id,
});
