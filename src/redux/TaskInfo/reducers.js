...
const initialState = {
  ...
  listid: "EECB8D15-092B-4EEA-A8D7-B784FEF6AB72",
  userid: "",
  newEntity: "",
  masterData: [],
  list: [],
...
const TaskInfoReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.TASKINFO_SET_CURRENTPAGE: {
    ...
    case types.TASKINFO_RESETALL: {
      const LoggedinUserInfo = sessionStorage.getItem("Globalid");
      return {
        ...initialState,
        userid: LoggedinUserInfo,
      };
    }
    case types.TASKINFO_GET_USERNAME: {
    ...
    case types.TASKINFO_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.TASKINFO_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.TASKINFO_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.TASKINFO_SELECT_NEW_ENTITY: {
    ...
    case types.TASKINFO_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.TASKINFO_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.TASKINFO_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.TASKINFO_SET_PAGINATION:
    ...
    case types.TASKINFO_SET_PAGE_SIZE:
      return {
        ...state,
    ...
    case types.TASKINFO_FETCH_DATASET_SUCCESS: {
      console.log(action.payload);
    ...
    case types.TASKINFO_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.TASKINFO_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.TASKINFO_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.TASKINFO_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.TASKINFO_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.TASKINFO_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.TASKINFO_SELECTED_FILTER_VALUE: {
    ...
    case types.TASKINFO_ADD_ADDITIONAL_FILTER: {
    ...
    case types.TASKINFO_SET_DROPDOWN_CHECKED: {
    ...
    case types.TASKINFO_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASKINFO_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.TASKINFO_REMOVE_QUICK_FILTER: {
    ...
    case types.TASKINFO_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.TASKINFO_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.TASKINFO_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.TASKINFO_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.TASKINFO_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.TASKINFO_SORTED_COLUMN: {
    ...
    case types.TASKINFO_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.TASKINFO_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.TASKINFO_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASKINFO_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TASKINFO_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.TASKINFO_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.TASKINFO_SET_DATEPICKER_VALUE: {
    ...
    case types.TASKINFO_SET_WEEKFILTER_VALUE: {
    ...
    case types.TASKINFO_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.TASKINFO_CHANGE_MASTER_DATA: {
    ...
    case types.TASKINFO_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.TASKINFO_EDIT_CELL: {
    ...
    case types.TASKINFO_RESET_EDIT_CELL: {
      const resetEditcell = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: null,
        workitemid: "",
