...
const FollowupReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.FOLLOWUP_SET_CURRENTPAGE: {
    ...
    case types.FOLLOWUP_GET_USERNAME: {
    ...
    case types.FOLLOWUP_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.FOLLOWUP_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.FOLLOWUP_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.FOLLOWUP_SELECT_NEW_ENTITY: {
    ...
    case types.FOLLOWUP_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.FOLLOWUP_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.FOLLOWUP_FETCH_LIST_DATA_SUCCESS:
    ...
    case types.FOLLOWUP_SET_PAGINATION:
    ...
    case types.FOLLOWUP_SET_PAGE_SIZE:
      return {
        ...state,
    ...
    case types.FOLLOWUP_FETCH_DATASET_SUCCESS: {
      console.log(action.payload);
      ...
      if (filters?.length === 0 && isdefault) {
        ...
        const selectedFiltersToAdd = filters
          .filter(
            (filter) =>
              ...
              filter.defaultvalue !== undefined &&
              filter.defaultvalue !== "" &&
              filter.defaultvalue !== "currentweek" &&
              filter.filtercontroltype !== "textbox"
          )
          .map((item) => ({
            filterid: item.id,
        ...
        console.log(selectedQuickTextFiltersToAdd);
        console.log(selectedAddTextFiltersToAdd);
      ...
      const updatednewQuickFilterData = QuickFilterData?.map((filter) => {
        if (
          filter.id === "abeecdd1-ba7a-4cad-a88b-e725b3586540" &&
          filter.defaultvalue === "loggedinuser"
        ) {
          console.log(filter);
      ...
      if (filters?.length > 0) {
        ...
        if (weekfilterdata.length > 0) {
          ...
          var updatedMasterData = state.masterData?.map((masterItem) => {
            ...
            if (weekFilterItem && weekFilterItem.defaultvalue !== null) {
              let startDate;
              if (weekFilterItem.defaultvalue === "currentweek") {
                const today = new Date();
                const currentWeek = getWeek(today);
                const currentYear = today.getFullYear();
                startDate = getDateOfWeek(currentWeek, currentYear);
              } else if (weekFilterItem.defaultvalue !== "") {
        ...
        //   [
        //     {
        //         "id": "faaec9b5-f213-410f-9f27-5c79d1c280e0",
        //         "api_name": "workweek",
        //         "name": "Plan week",
        //         "week": 3,
        //         "year": 2024
        ...
        const defaultweekFilter2 = filters
          .filter(
            (filter) =>
              filter.filterid === "workweek" &&
              filter.defaultvalue !== null &&
        ...
        updateweekFilter.push(...defaultweekFilter2);
    ...
    case types.FOLLOWUP_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.FOLLOWUP_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.FOLLOWUP_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.FOLLOWUP_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.FOLLOWUP_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.FOLLOWUP_CHANGE_HORIZONTAL_GROUPBY: {
      ...
      if (id === "40353c80-98ad-4aae-bb43-0cd8e767f8e7") {
        // ~ Work Week
        ...
        if (groupByIndex !== -1) {
          updatedCreateGroupByData[groupByIndex] = {
            ...updatedCreateGroupByData[groupByIndex],
            value: optionid === "All" ? optionid : sortedItem?.value, // Assuming optionid is a string
    ...
    case types.FOLLOWUP_SELECTED_FILTER_VALUE: {
    ...
    case types.FOLLOWUP_ADD_ADDITIONAL_FILTER: {
    ...
    case types.FOLLOWUP_SET_DROPDOWN_CHECKED: {
    ...
    case types.FOLLOWUP_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FOLLOWUP_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.FOLLOWUP_REMOVE_QUICK_FILTER: {
    ...
    case types.FOLLOWUP_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.FOLLOWUP_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.FOLLOWUP_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.FOLLOWUP_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.FOLLOWUP_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.FOLLOWUP_SORTED_COLUMN: {
    ...
    case types.FOLLOWUP_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.FOLLOWUP_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.FOLLOWUP_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FOLLOWUP_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.FOLLOWUP_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.FOLLOWUP_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.FOLLOWUP_SET_DATEPICKER_VALUE: {
    ...
    case types.FOLLOWUP_SET_WEEKFILTER_VALUE: {
    ...
    case types.FOLLOWUP_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.FOLLOWUP_CHANGE_MASTER_DATA: {
    ...
    case types.FOLLOWUP_SET_LOADING: {
      return {
        ...state,
