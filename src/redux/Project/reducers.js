...
const initialState = {
  ...
  listid: "DD1AB1F0-31E1-4BEE-80E2-3EFFC73AD752",
  userid: "",
  newEntity: "",
  masterData: [],
  list: [],
...
const ProjectReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.PROJECT_GET_USERNAME: {
    ...
    case types.PROJECT_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.PROJECT_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.PROJECT_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.PROJECT_SELECT_NEW_ENTITY: {
    ...
    case types.PROJECT_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.PROJECT_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.PROJECT_FETCH_LIST_DATA_SUCCESS:
    ...
    case types.PROJECT_SET_PAGINATION:
    ...
    case types.PROJECT_SET_PAGE_SIZE:
      return {
        ...state,
        postData: {
          ...state.postData,
    ...
    case types.PROJECT_FETCH_DATASET_SUCCESS: {
    ...
    case types.PROJECT_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.PROJECT_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.PROJECT_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.PROJECT_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.PROJECT_CREATE_HOR_GROUPBYDATA_DIRECTION: {
    ...
    case types.PROJECT_CREATE_HOR_GROUPBYDATA: {
      const { payload } = action;
      console.log(payload);
    ...
    case types.PROJECT_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.PROJECT_SELECTED_FILTER_VALUE: {
    ...
    case types.PROJECT_ADD_ADDITIONAL_FILTER: {
    ...
    case types.PROJECT_SET_DROPDOWN_CHECKED: {
    ...
    case types.PROJECT_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PROJECT_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.PROJECT_REMOVE_QUICK_FILTER: {
    ...
    case types.PROJECT_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.PROJECT_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PROJECT_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.PROJECT_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.PROJECT_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.PROJECT_SORTED_COLUMN: {
    ...
    case types.PROJECT_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.PROJECT_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.PROJECT_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PROJECT_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PROJECT_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.PROJECT_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.PROJECT_SET_DATEPICKER_VALUE: {
    ...
    case types.PROJECT_SET_WEEKFILTER_VALUE: {
    ...
    case types.PROJECT_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.PROJECT_CHANGE_MASTER_DATA: {
    ...
    case types.PROJECT_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.PROJECT_SET_CURRENTPAGE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PROJECT_RESET_EDIT_CELL: {
      const resetEditcell = {
