...
const initialState = {
  ...
  listid: "AA9E5383-E62F-4A79-AB21-6FD6E455DABB",
...
const PlanReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.PLAN_SET_CURRENTPAGE: {
    ...
    case types.PLAN_FETCH_PLAN_DATA_SUCCESS: {
    ...
    case types.PLAN_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.PLAN_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.PLAN_SELECT_NEW_ENTITY: {
    ...
    case types.PLAN_FETCH_MASTER_DATA_SUCCESS:
      ...
      const parsedMasterData = masterData.map((item) => {
        const mastervalues =
          typeof item.mastervalues !== "object"
            ? JSON.parse(item.mastervalues)
            : [];
        const updatedMasterValues = SortingWithoutDirection(
          mastervalues,
          "optionvalue"
        );
        return {
          ...item,
          mastervalues: updatedMasterValues,
          // mastervalues: typeof item.mastervalues !== "object" ? JSON.parse(item.mastervalues) : []
        };
      });
    ...
    case types.PLAN_FETCH_SUB_MASTER_DATA_SUCCESS:
    ...
    case types.PLAN_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.PLAN_FETCH_LIST_DATA_SUCCESS:
    ...
    case types.PLAN_SET_PAGINATION:
    ...
    case types.PLAN_FETCH_DATASET_SUCCESS: {
      console.log(action.payload);
      ...
      updatedPostData.planweek = `${currentplanWeek}$${currentplanYear}`;
      updatedPostData.planassignedto = state.userid;
      ...
      if (groupby.length > 0) {
        const defaultGroup = groupby
          ...
          .map((item) => ({
            filterid: item.id,
            apiname: item.api_name,
            filtervalue: item.defaultvalue === "" ? "0" : item.defaultvalue,
            condition: "AND",
          }));
      ...
      if (groupby.length > 0) {
        ...
        if (groupby.some((item) => item.api_name === "column41")) {
          updatedHorizontalGroupBy = groupby
            .filter((item) => item.api_name === "column41")
            .map((item) => {
              console.log(state.masterData);
              const masterMatch = state.masterData?.find(
                (data) => data.masterid === item.masterid
    ...
    case types.PLAN_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.PLAN_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.PLAN_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.PLAN_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.PLAN_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.PLAN_CHANGE_HORIZONTAL_GROUPBY: {
      const { id, optionid } = action.payload;
      console.log(id, optionid);
      const updatedPostData = { ...state.postData };

      const changedhorizontalGroupBy = [...state.horizontalGroupBy];
      console.log(changedhorizontalGroupBy);

      if (changedhorizontalGroupBy.length > 0) {
    ...
    case types.PLAN_SELECTED_FILTER_VALUE: {
    ...
    case types.PLAN_ADD_ADDITIONAL_FILTER: {
    ...
    case types.PLAN_SET_DROPDOWN_CHECKED: {
    ...
    case types.PLAN_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PLAN_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.PLAN_REMOVE_QUICK_FILTER: {
    ...
    case types.PLAN_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.PLAN_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PLAN_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.PLAN_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.PLAN_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.PLAN_SORTED_COLUMN: {
    ...
    case types.PLAN_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.PLAN_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.PLAN_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PLAN_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.PLAN_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.PLAN_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.PLAN_SET_DATEPICKER_VALUE: {
    ...
    case types.PLAN_SET_WEEKFILTER_VALUE: {
    ...
    case types.PLAN_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.PLAN_CHANGE_MASTER_DATA: {
    ...
    case types.PLAN_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.PLAN_SET_TRANSACTIONID: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PLAN_360_FETCH_LIST_FIELDS_SUCCESS:
      const newlistfields =
        action.payload &&
        action.payload?.result?.list[0]?.data?.config?.listfields;
    ...
    case types.PLAN_360_DATASET_SUCCESS: {
      console.log(action.payload);
      const { columns } = action.payload?.result;
    ...
    case types.PLAN_360_TASK_ROW_DATA: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PLAN_360_FETCH_SUB_LIST_FIELDS_SUCCESS: {
      const newlistfields =
        action.payload &&
        action.payload?.result?.list[0]?.data?.config?.listfields;
      console.log(newlistfields);
    ...
    case types.PLAN_360_SUB_DATASET_SUCCESS: {
      console.log(action.payload);
      const { columns } = action.payload?.result;
    ...
    case types.PLAN_360_SUB_TASK_ROW_DATA: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.PLAN_ASSIGNED_TO: {
      console.log(action.payload);
      const updatedPostData = {
        ...state.postData,
        planassignedto: action.payload,
      };
      return {
        ...state,
        postData: updatedPostData,
    ...
    case types.PLAN_INSERT_PLAN: {
      console.log(action.payload);
      //  const { apiname, transactionid, type } = action.payload;

      let updatedInsertdata = { ...state.insertData };
      console.log(updatedInsertdata);
      const currentplanweek = state.postData.planweek;
      console.log(currentplanweek);
      const [week, year] = currentplanweek.split("$");
      ...
      const loggeduser = state.postData.planassignedto;
      switch (apiname) {
        case "d1":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[0];
          break;
        case "d2":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[1];
          break;
        case "d3":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[2];
          break;
        case "d4":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[3];
          break;
        case "d5":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[4];
          break;
        case "d6":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[5];
          break;
        case "d7":
          updatedInsertdata.apiname = apiname;
          updatedInsertdata.transactionid = transactionid;
          updatedInsertdata.type = type;
          updatedInsertdata.userid = loggeduser;
          updatedInsertdata.value = weekDates[6];
          break;
        default:
          break;
      }
      ...
      return {
        ...state,
        insertData: updatedInsertdata,
      };
    }
    case types.PLAN_RESET_INSERT_PLAN: {
      const resetInsertdata = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: "",
        userid: "",
        apiname: "",
