...
const initialState = {
  entities: [],
  entityid: "7E6694D1-8477-4E8A-A19F-477156E832FF",
  listid: "C5D93CE1-4181-4EE8-B6C2-CB728A3D531D",
  userid: "",
  newEntity: "",
  masterData: [],
  list: [],
...
const TagReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.TAG_SET_CURRENTPAGE: {
    ...
    case types.TAG_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.TAG_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.TAG_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.TAG_SELECT_NEW_ENTITY: {
    ...
    case types.TAG_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.TAG_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.TAG_SET_PAGINATION:
    ...
    case types.TAG_FETCH_DATASET_SUCCESS: {
      console.log(action.payload);
    ...
    case types.TAG_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.TAG_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.TAG_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.TAG_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.TAG_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.TAG_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.TAG_SELECTED_FILTER_VALUE: {
    ...
    case types.TAG_REMOVE_TEXT_FILTER: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.TAG_ADD_ADDITIONAL_FILTER: {
    ...
    case types.TAG_SET_DROPDOWN_CHECKED: {
    ...
    case types.TAG_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TAG_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.TAG_REMOVE_QUICK_FILTER: {
    ...
    case types.TAG_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.TAG_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.TAG_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
      // Check if action.payload is an array or not
      if (Array.isArray(action.payload)) {
    ...
    case types.TAG_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.TAG_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.TAG_SORTED_COLUMN: {
    ...
    case types.TAG_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.TAG_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.TAG_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TAG_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.TAG_SET_DATEPICKER_VALUE: {
    ...
    case types.TAG_SET_WEEKFILTER_VALUE: {
    ...
    case types.TAG_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.TAG_CHANGE_MASTER_DATA: {
    ...
    case types.TAG_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.TAG_EDIT_CELL: {
    ...
    case types.TAG_RESET_EDIT_CELL: {
      const resetEditcell = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: null,
        workitemid: "",
