...
const initialState = {
  entities: [],
  entityid: "68DFCE73-F8B2-4996-A7BF-48843CF7B026",
  listid: "629F19F7-B830-4AA4-9146-C27CFCC75259",
  userid: "",
  email: "",
  newEntity: "",
  masterData: [],
...
const JourneyReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.JOURNEY_GET_USERNAME: {
    ...
    case types.JOURNEY_GET_USERMAIL: {
    ...
    case types.JOURNEY_FETCH_ENTITY_DATA_SUCCESS: {
    ...
    case types.JOURNEY_INCREMENT_COUNT:
      return {
        ...state,
        renderCount: state.renderCount + 1,
      };
    case types.JOURNEY_SET_DATASETID:
      return {
        ...state,
        savedDatasetid: action.payload,
      };
    case types.JOURNEY_SELECT_NEW_ENTITY: {
    ...
    case types.JOURNEY_FETCH_MASTER_DATA_SUCCESS:
    ...
    case types.JOURNEY_FETCH_LIST_FIELDS_SUCCESS:
      const listfields =
        action.payload &&
    ...
    case types.JOURNEY_FETCH_LIST_DATA_SUCCESS:
      return {
        ...state,
        listData: action.payload?.result,
      };
    case types.JOURNEY_SET_PAGINATION:
    ...
    case types.JOURNEY_SET_PAGE_SIZE:
      return {
        ...state,
        postData: {
          ...state.postData,
    ...
    case types.JOURNEY_FETCH_DATASET_SUCCESS: {
    ...
    case types.JOURNEY_SET_ADV_MATCHED_LOOKUP:
    ...
    case types.JOURNEY_SET_MATCHED_LOOKUP:
      if (!action.payload || Object.keys(action.payload).length === 0) {
        console.log(action.payload);
        return {
          ...state,
    ...
    case types.JOURNEY_TOGGLE_COLUMN_ISMAPPING: {
    ...
    case types.JOURNEY_TOGGLE_FILTER_ISMAPPING: {
    ...
    case types.JOURNEY_CREATE_HOR_GROUPBYDATA: {
    ...
    case types.JOURNEY_CHANGE_HORIZONTAL_GROUPBY: {
    ...
    case types.JOURNEY_SELECTED_FILTER_VALUE: {
    ...
    case types.JOURNEY_ADD_ADDITIONAL_FILTER: {
    ...
    case types.JOURNEY_SET_DROPDOWN_CHECKED: {
    ...
    case types.JOURNEY_SET_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.JOURNEY_REMOVE_ALL_FILTER: {
      console.log(action.payload);
    ...
    case types.JOURNEY_REMOVE_QUICK_FILTER: {
    ...
    case types.JOURNEY_REMOVE_ADVANCED_FILTER: {
      console.log(action.payload);
    ...
    case types.JOURNEY_QUICK_TEXT_VALUE: {
      console.log(action.payload);
      return {
        ...state,
    ...
    case types.JOURNEY_RESET_QUICK_FILTER_VALUES: {
      let filterIds = [];
      console.log(action.payload);
    ...
    case types.JOURNEY_CREATE_NEW_DATASET:
      return {
        ...state,
        newDataset: action.payload,
      };
    case types.JOURNEY_EDIT_DATASET:
      console.log(action.payload);
      return {
        ...state,
        updateDataSet: action.payload,
      };
    case types.JOURNEY_SORTED_COLUMN: {
    ...
    case types.JOURNEY_GET_NEW_DATASET_INFO_SUCCESS: {
    ...
    case types.JOURNEY_DELETE_DATASET_DB: {
      console.log(action.payload);
    ...
    case types.JOURNEY_SET_ADV_DROPDOWN_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.JOURNEY_SET_ADV_MULTISELECT_CHECKED: {
      const { masterid, selectedValue, isChecked } = action.payload;
      console.log(masterid);
      console.log(selectedValue);
      console.log(isChecked);
    ...
    case types.JOURNEY_SET_NEW_LAYOUT:
      const updatedTotalColumn = [...state.totalColumns];
    ...
    case types.JOURNEY_SET_COLUMN_SEQ: {
      const updatedTotalColumn = [...state.totalColumns];
      console.log(action.payload);
    ...
    case types.JOURNEY_SET_DATEPICKER_VALUE: {
    ...
    case types.JOURNEY_SET_WEEKFILTER_VALUE: {
    ...
    case types.JOURNEY_RESET_DATE_FILTERS: {
      console.log("it runs");
      return initialState;
    }
    case types.JOURNEY_CHANGE_MASTER_DATA: {
    ...
    case types.JOURNEY_SET_LOADING: {
      return {
        ...state,
        loading: action.payload,
      };
    }
    case types.JOURNEY_EDIT_CELL: {
    ...
    case types.JOURNEY_RESET_EDIT_CELL: {
      const resetEditcell = {
        entityid: "26B84156-CC30-416E-99D5-B37409B4D0BD",
        transactionid: null,
        workitemid: "",
